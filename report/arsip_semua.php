            ...
            <div class='row'>
                <div class="col-sm-12">
                    ...
                    <div class="text-center">
                        ...
                        <hr>
                        <h3>DATA SELURUH AKTA</h3>
                        <table class="table table-bordered table-striped table-hover"> 
                        <tbody>
                                <thead>
								<tr>
									<th>No.</th><th width="18%">Nomor Akta</th><th width="10%">Tgl. Masuk</th><th width="15%"><center>Para Pihak</center></th><th><center>Jenis Akta</center></th>
								</tr>
								</thead>
							<tbody>
