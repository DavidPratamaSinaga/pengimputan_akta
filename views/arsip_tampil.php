        ...
        <div class="col-xs-12">
            <div class="panel panel-success">
                <div class="panel-heading">
                    <h3 class="panel-title"><span class="fa fa-user-plus"></span> Data Akta</h3>
                </div>
                <div class="panel-body">
                    <table id="dtskripsi" class="table table-bordered table-striped table-hover">
                        <thead>
                            <tr>
                                <th>No.</th><th>No Akta</th><th>Tanggal</th><th>Para Pihak Terlibat</th><th>Jenis Akta</th><th>ACTIONS</th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            while ($data = mysqli_fetch_array($query)) {
                                ...
                                <tr>
                                    ...
                                    <td>
										...
										<a href="?page=peminjaman&actions=tambah&nope=<?= $data['no_akta'] ?>" class="btn btn-info btn-xs">
